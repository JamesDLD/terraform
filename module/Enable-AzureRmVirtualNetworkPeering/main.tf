...
data "azurerm_virtual_network" "one_vnets" {
  ...
  name                = var.list_one[count.index]["name"]
  resource_group_name = var.list_one[count.index]["resource_group_name"]
}
...
resource "azurerm_virtual_network_peering" "one_dest_to_source" {
  ...
  resource_group_name = element(
    data.azurerm_virtual_network.one_vnets.*.resource_group_name,
    count.index,
  )
...
data "azurerm_virtual_network" "two_vnets" {
  ...
  name                = var.list_two[count.index]["name"]
  resource_group_name = var.list_two[count.index]["resource_group_name"]
}
...
resource "azurerm_virtual_network_peering" "two_dest_to_source" {
  ...
  name     = var.vnet_src_name
  resource_group_name = element(
    data.azurerm_virtual_network.two_vnets.*.resource_group_name,
    count.index,
  )
...
data "azurerm_virtual_network" "three_vnets" {
  ...
  name                = var.list_three[count.index]["name"]
  resource_group_name = var.list_three[count.index]["resource_group_name"]
}
...
resource "azurerm_virtual_network_peering" "three_dest_to_source" {
  ...
  name     = var.vnet_src_name
  resource_group_name = element(
    data.azurerm_virtual_network.three_vnets.*.resource_group_name,
    count.index,
  )
...
data "azurerm_virtual_network" "four_vnets" {
  ...
  name                = var.list_four[count.index]["name"]
  resource_group_name = var.list_four[count.index]["resource_group_name"]
}
...
resource "azurerm_virtual_network_peering" "four_dest_to_source" {
  ...
  name     = var.vnet_src_name
  resource_group_name = element(
    data.azurerm_virtual_network.four_vnets.*.resource_group_name,
    count.index,
  )
...
data "azurerm_virtual_network" "five_vnets" {
  ...
  name                = var.list_five[count.index]["name"]
  resource_group_name = var.list_five[count.index]["resource_group_name"]
}
...
resource "azurerm_virtual_network_peering" "five_dest_to_source" {
  ...
  name     = var.vnet_src_name
  resource_group_name = element(
    data.azurerm_virtual_network.five_vnets.*.resource_group_name,
    count.index,
  )
...
data "azurerm_virtual_network" "six_vnets" {
  ...
  name                = var.list_six[count.index]["name"]
  resource_group_name = var.list_six[count.index]["resource_group_name"]
}
...
resource "azurerm_virtual_network_peering" "six_dest_to_source" {
  ...
  name     = var.vnet_src_name
  resource_group_name = element(
    data.azurerm_virtual_network.six_vnets.*.resource_group_name,
    count.index,
  )
...
data "azurerm_virtual_network" "seven_vnets" {
  ...
  name                = var.list_seven[count.index]["name"]
  resource_group_name = var.list_seven[count.index]["resource_group_name"]
}
...
resource "azurerm_virtual_network_peering" "seven_dest_to_source" {
  ...
  name     = var.vnet_src_name
  resource_group_name = element(
    data.azurerm_virtual_network.seven_vnets.*.resource_group_name,
    count.index,
  )
...
data "azurerm_virtual_network" "eight_vnets" {
  ...
  name                = var.list_eight[count.index]["name"]
  resource_group_name = var.list_eight[count.index]["resource_group_name"]
}
...
resource "azurerm_virtual_network_peering" "eight_dest_to_source" {
  ...
  name     = var.vnet_src_name
  resource_group_name = element(
    data.azurerm_virtual_network.eight_vnets.*.resource_group_name,
    count.index,
  )
